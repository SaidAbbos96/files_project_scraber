...
class SessionManager:
    ...
    def find_session_file(self):
        ...
        print(f"⚠️ Session fayli topilmadi, default ishlatiladi: {default_session}")
        return default_session
    ...
    def is_session_locked(self, verbose=True):
        ...
        try:
            ...
            conn = sqlite3.connect(self.session_file, timeout=self.lock_timeout)
    ...
    def delete_locked_session(self):
        ...
        try:
            if os.path.exists(self.session_file):
                ...
                print(f"🗑️  Bloklanagan session fayli o'chirildi: {self.session_file}")
                return True
        except Exception as e:
            ...
            if os.path.exists(self.session_file):
                try:
                    ...
                    try:
                        os.remove(self.session_file)
                        if verbose:
                            print("🗑️ Session fayli butunlay o'chirildi, yangi session yaratiladi")
                        return True
